...
// const Header = ({ CartCountFunc, CartCount, searchfunc }) => {
...
//                     <input className="form-control me-2 search-box" type="search" placeholder="Search" aria-label="Search" value={searchs} onChange={(e) => { Setsearchs(e.target.value) }} />
//                     <button className="btn btn-outline-success" type="submit" onClick={searchfunc}>Search</button>
//                   </form>
//                 </div>
...
//                   </svg>
//                   <span onClick={() => { sign === "Log in" ? setSign("Log out") : setSign("Log in") }}>{sign}</span>
//                 </a>
//               </li>
//               <li className="nav-item">
//                 <a className="nav-link" href="#">
...
//                     </svg>
//                     <span className="cart_count_value" onClick={CartCountFunc}>{CartCount}</span>
//                   </span>
//                   <span>Cart</span>
//                 </a>
//               </li>
